...
export const GET_A_NEWSLETTER_START = "GET_A_NEWSLETTER_START";
export const GET_A_NEWSLETTER_SUCCESS = "GET_A_NEWSLETTER_SUCCESS";
export const GET_A_NEWSLETTER_FAIL = "GET_A_NEWSLETTER_FAIL";
